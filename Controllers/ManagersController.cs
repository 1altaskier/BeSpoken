...
namespace BeSpoken.Controllers
{
    public class ManagersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ManagerId,FirstName,LastName,Phone")] Manager manager)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ManagerId,FirstName,LastName,Phone")] Manager manager)
        {
            if (ModelState.IsValid)
            {
